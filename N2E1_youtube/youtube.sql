...
INSERT INTO `youtube`.`video` (`video_id`, `titol`, `descripcio`, `grandaria`, `nom`, `durada`, `reproduciones`, `likes`, `dislikes`, `estat`, `etiqueta_id`, `publicacio`, `usuari_id`) VALUES (1, 'Michael Jackson', 'Michael Joseph Jackson (Gary, Indiana, 29 de agosto de 1958-Los Ángeles, 25 de junio de 2009)​ fue un cantante, compositor.', '8K', '1.mp4', '05:55', 40, 30, 1, 'ocult', 1, '2023-01-18 09:49:43', 1);
INSERT INTO `youtube`.`video` (`video_id`, `titol`, `descripcio`, `grandaria`, `nom`, `durada`, `reproduciones`, `likes`, `dislikes`, `estat`, `etiqueta_id`, `publicacio`, `usuari_id`) VALUES (2, 'Final Roland Garros', 'La final masculina de Roland Garros 2022 se celebrará el domingo 5 de junio en la pista Philippe Chatrier de París.', '2K', '2.mp4', '04:35', 50, 23, 5, 'public', 2, '2023-01-18 09:49:43', 2);
INSERT INTO `youtube`.`video` (`video_id`, `titol`, `descripcio`, `grandaria`, `nom`, `durada`, `reproduciones`, `likes`, `dislikes`, `estat`, `etiqueta_id`, `publicacio`, `usuari_id`) VALUES (3, 'Marta haciendo el pino', 'marta del pino. @delpinoprensa. hago prensa, leo y no me importa tener razón mardepinos@gmail.com. Buenos Aires, Argentina Joined May 2012.', '4K', '3.mp4', '00:59', 230, 44, 3, 'privat', 1, '2023-01-18 09:49:43', 3);
...
INSERT INTO `youtube`.`video` (`video_id`, `titol`, `descripcio`, `grandaria`, `nom`, `durada`, `reproduciones`, `likes`, `dislikes`, `estat`, `etiqueta_id`, `publicacio`, `usuari_id`) VALUES (5, 'Billie Holiday las quiero ya', 'Billie Holiday - All Of You (Letras y canción para escuchar) - I love the look(s) of you, (and) the lure of you / The sweet of you, and the pure of yo..', '2K', '5.mp4', '02:45', 567, 22, 5, 'public', 4, '2023-01-18 09:49:43', 5);
